...
def main():
    st.set_page_config(page_title="Obesity Level Prediction Using Random Forest", layout="centered")
    ...
    st.title('Obesity Level Prediction Using Random Forest')
    st.markdown("""
    ...
    if st.button('Predict'):
        if height is None or weight is None or age is None:
            ...
            # Reorder the input features to match the order expected by the scaler
            input_features = pd.DataFrame([[age, height, weight, frequency]], 
